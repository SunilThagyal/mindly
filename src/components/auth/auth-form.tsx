...
export default function AuthForm({ mode }: AuthFormProps) {
  ...
  const handleSocialLogin = async (providerType: 'google' | 'github') => {
    ...
    try {
      ...
      providerType === 'google' ? setIsGoogleLoading(false) : setIsGithubLoading(false);
    }
  };
      ...
      <Card className="w-full max-w-md shadow-xl">
        ...
        <CardFooter className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            ...
            <Button variant="outline" onClick={() => handleSocialLogin('github')} disabled={isGithubLoading || isLoading}>
